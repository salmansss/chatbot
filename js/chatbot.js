function chatBot() {
	...
	this.respondTo = function(input) {
		...
		if(this.match('(hi|hello|hii|hiii|hiiii|hey|hola|howdy)(\\s|!|\\.|$)'))
		...
		if(this.match('(how many courses are available?|courses)'))
			return "We offer computer engineering,information technology,extc,electronic,automobile,mechanical";
		...
		if(this.match('(vacation|vacations)'))
		...
		if(this.match('(sem 7 subject|sem 7)'))
			return "DSP,CSS,AI,ERP";
		
		if(this.match('(sem 8 subject|sem 8)'))
			return "PDS,DWM,BDA,HMI";
		
		if(this.match('(providing bus facility|bus|bus facility)'))
			return "YES";
		
		if(this.match('computer enginerring intake'))
			return "YES,60 student";
		
		if(this.match('principle'))
			return "Dr.N.K Rana";
		
		if(this.match('college name|college|theem'))
			return "Theem College of Engineering";
		
		if(this.match('(are you online|live|online)'))
			return "No,I am offline";
		
		if(this.match('canteen'))
			return "YES";
