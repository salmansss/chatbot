...
<h2>About Faculty</h2>
<p>The Faculty can login and ask any<br>
kind of information that is required<br>
Kindly provide a proper login id</p>
<center><form name="f" action="faculty.php" onsubmit="return validation();" method="post"> 
...
if(mysqli_connect_error()){
	...
	$sql = "INSERT INTO faculty (username,password)
